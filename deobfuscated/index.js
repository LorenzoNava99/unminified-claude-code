...
function LA(mA, ZA) {
  ...
  if (!mA.name) {
    ...
    var D1 = hA ? V.resolve(MA._dbInfo.db) : y(mA).then(function (T1) {
      var O1 = N[mA.name];
      var _1 = O1.forages;
      O1.db = T1;
...
function GB(mA, ZA) {
  ...
  if (mA && (e === "[object ArrayBuffer]" || mA.buffer && D0.call(mA.buffer) === "[object ArrayBuffer]")) {
    var MA;
    var _A = TA;
  ...
  var MA = new V(function (_A, hA) {
    e.ready().then(function () {
      ...
      D1.db.transaction(function (T1) {
        p2(T1, D1, "SELECT * FROM " + D1.storeName + " WHERE key = ? LIMIT 1", [mA], function (O1, _1) {
...
function qI(mA, ZA) {
  ...
  var MA = new V(function (_A, hA) {
    e.ready().then(function () {
      var D1 = e._dbInfo;
      D1.db.transaction(function (T1) {
        p2(T1, D1, "SELECT * FROM " + D1.storeName, [], function (O1, _1) {
          var h1 = _1.rows;
          var Q0 = h1.length;
    ...
    _A.ready().then(function () {
      ...
      _1.serializer.serialize(ZA, function (h1, Q0) {
        if (Q0) {
          ...
          _1.db.transaction(function (d0) {
            p2(d0, _1, "INSERT OR REPLACE INTO " + _1.storeName + " (key, value) VALUES (?, ?)", [mA, h1], function () {
              D1(O1);
            }, function (_B, MQ) {
              T1(MQ);
            });
...
function cI(mA, ZA) {
  ...
  var MA = new V(function (_A, hA) {
    e.ready().then(function () {
      var D1 = e._dbInfo;
      D1.db.transaction(function (T1) {
        p2(T1, D1, "DELETE FROM " + D1.storeName + " WHERE key = ?", [mA], function () {
          _A();
        }, function (O1, _1) {
          hA(_1);
        });
  ...
  var e = new V(function (MA, _A) {
    ZA.ready().then(function () {
      ...
      hA.db.transaction(function (D1) {
        p2(D1, hA, "DELETE FROM " + hA.storeName, [], function () {
          MA();
        }, function (T1, O1) {
          _A(O1);
        });
...
function l7(mA) {
  ...
  var e = new V(function (MA, _A) {
    ZA.ready().then(function () {
      var hA = ZA._dbInfo;
      hA.db.transaction(function (D1) {
        p2(D1, hA, "SELECT COUNT(key) as c FROM " + hA.storeName, [], function (T1, O1) {
...
function l9(mA, ZA) {
  ...
  var MA = new V(function (_A, hA) {
    e.ready().then(function () {
      var D1 = e._dbInfo;
      D1.db.transaction(function (T1) {
        p2(T1, D1, "SELECT key FROM " + D1.storeName + " WHERE id = ? LIMIT 1", [mA + 1], function (O1, _1) {
...
function R6(mA) {
  ...
  var e = new V(function (MA, _A) {
    ZA.ready().then(function () {
      var hA = ZA._dbInfo;
      hA.db.transaction(function (D1) {
        p2(D1, hA, "SELECT key FROM " + hA.storeName, [], function (T1, O1) {
          var _1 = [];
...
var t5 = [E4.INDEXEDDB._driver, E4.WEBSQL._driver, E4.LOCALSTORAGE._driver];
var v4 = ["dropInstance"];
var n6 = ["clear", "getItem", "iterate", "key", "keys", "length", "removeItem", "setItem"].concat(v4);
var P9 = {
  description: "",
  driver: t5.slice(),
  name: "localforage",
...
var j9 = function () {
  ...
  mA.prototype.getDriver = function (e, MA, _A) {
    var hA = T6[e] ? V.resolve(T6[e]) : V.reject(Error("Driver not found."));
    D(hA, MA, _A);
    return hA;
  };
