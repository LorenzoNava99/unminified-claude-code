...
import otelCoreUtilsModule from './otel-core-utils.js';

console.log('🧪 Testing otelCoreUtils');
...
test('Module exports exist', () => {
  if (!otelCoreUtilsModule) throw new Error('Module is undefined');
});

// Test 2: Module is an object
test('Module is an object', () => {
  if (typeof otelCoreUtilsModule !== 'object') {
    throw new Error(`Expected object, got ${typeof otelCoreUtilsModule}`);
  }
});
