...
import OtelMetricsModule from './otel-metrics.js';

console.log('🧪 Testing OtelMetrics');
...
test('Module exports exist', () => {
  if (!OtelMetricsModule) throw new Error('Module is undefined');
});

// Test 2: Module is an object
test('Module is an object', () => {
  if (typeof OtelMetricsModule !== 'object') {
    throw new Error(`Expected object, got ${typeof OtelMetricsModule}`);
  }
});
